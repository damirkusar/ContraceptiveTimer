...
public class CalendarWrapper {
	...
	public long getTimeInMillis() {
		GregorianCalendar calInstance = CalendarWrapper
				.getGregorianCalendarInstance();

		GregorianCalendar cal = this
				.convertToCalendarWithoutHourMinutesSeconds(calInstance);
	...
	private GregorianCalendar convertToCalendarWithoutHourMinutesSeconds(
			Calendar calendar) {
