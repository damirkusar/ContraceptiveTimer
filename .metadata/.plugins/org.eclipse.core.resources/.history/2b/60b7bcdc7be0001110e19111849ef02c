...
public class AlarmDataCalculatorTest extends AndroidTestCase {
	...
	public void testIsTimeToMakeSevenDaysBreak_LastBreakIs21DaysAgo_ExpectedTrue() {
		...
		this.alarmDataCalculator.getNumberOfDaysSinceLastBreak();

		Assert.assertTrue(this.alarmDataCalculator.isTimeToMakeSevenDaysBreak());
	}
	...
	public void testGetLastAlarmCalendarDay_LastBreakIs21DaysAgoAndTypeIsRing_ExpectedCalendarIs14DaysAgo() {
		...
		Calendar lastAlarmCalendarDay = this.alarmDataCalculator
