...
public class CalendarWrapperForTest {
	...
	public static GregorianCalendar getLastSunday() {
		...
		calendar.set(
				...
				(calendar.get(Calendar.DAY_OF_YEAR) - CalendarWrapperForTest
	...
	public static GregorianCalendar getLastSaturday() {
		...
		calendar.set(
				...
				(calendar.get(Calendar.DAY_OF_YEAR)
						- CalendarWrapperForTest
								.convertFromCalendarDayToNormal7DaysScale(todaysWeekDay) - 1));
		return (GregorianCalendar) calendar;
	}
	...
	public static GregorianCalendar getYesterday() {
		CalendarWrapperForTest.getActualCalendarWithoutHourMinutesSeconds()
